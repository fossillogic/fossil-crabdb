...
// *****************************************************************************
// NoShell Enhanced API - Prototypes
// *****************************************************************************
 ...
 * @return              FOSSIL_NOSHELL_ERROR_SUCCESS on success, otherwise error code.
 */
fossil_noshell_error_t fossil_noshell_find_cb(const char *file_name, bool (*cb)(const char *document, void *userdata), void *userdata);
