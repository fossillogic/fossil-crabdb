...
FOSSIL_TEST_CASE(cpp_test_crabdb_create) {
...
FOSSIL_TEST_CASE(cpp_test_crabdb_destroy) {
    fossil_crabdb_t* db = fossil_crabdb_create();
...
FOSSIL_TEST_CASE(cpp_test_crabdb_select_non_existing_key) {
    fossil_crabdb_t* db = fossil_crabdb_create();
    char value[FOSSIL_CRABDB_VAL_SIZE];
...
FOSSIL_TEST_CASE(cpp_test_crabdb_delete_non_existing_key) {
    fossil_crabdb_t* db = fossil_crabdb_create();
...
FOSSIL_TEST_CASE(cpp_test_crabdb_cleanup_expired) {
    fossil_crabdb_t* db = fossil_crabdb_create();
...
FOSSIL_TEST_CASE(cpp_test_crabdb_select_null_key) {
    fossil_crabdb_t* db = fossil_crabdb_create();
    char value[FOSSIL_CRABDB_VAL_SIZE];
...
FOSSIL_TEST_CASE(cpp_test_crabdb_update_null_key) {
    fossil_crabdb_t* db = fossil_crabdb_create();
...
FOSSIL_TEST_CASE(cpp_test_crabdb_delete_null_key) {
    fossil_crabdb_t* db = fossil_crabdb_create();
...
FOSSIL_TEST_CASE(cpp_test_crabdb_insert_large_data) {
    fossil_crabdb_t* db = fossil_crabdb_create();
...
FOSSIL_TEST_CASE(cpp_test_crabdb_delete_batch_non_existing_keys) {
    fossil_crabdb_t* db = fossil_crabdb_create();
...
FOSSIL_TEST_CASE(cpp_test_crabdb_create_table) {
    fossil_crabdb_t* db = fossil_crabdb_create();
...
FOSSIL_TEST_CASE(cpp_test_crabdb_create_duplicate_table) {
    fossil_crabdb_t* db = fossil_crabdb_create();
...
FOSSIL_TEST_CASE(cpp_test_crabdb_delete_table) {
    fossil_crabdb_t* db = fossil_crabdb_create();
    fossil_crabdb_create_table(db, "table1");
...
FOSSIL_TEST_CASE(cpp_test_crabdb_delete_non_existing_table) {
    fossil_crabdb_t* db = fossil_crabdb_create();
...
FOSSIL_TEST_CASE(cpp_test_crabdb_select_non_existing_table) {
    fossil_crabdb_t* db = fossil_crabdb_create();
    char value[FOSSIL_CRABDB_VAL_SIZE];
...
FOSSIL_TEST_CASE(cpp_test_crabdb_batch_insert_table) {
    fossil_crabdb_t* db = fossil_crabdb_create();
    fossil_crabdb_create_table(db, "table1");
...
FOSSIL_TEST_CASE(cpp_test_crabdb_table_exists) {
    fossil_crabdb_t* db = fossil_crabdb_create();
    fossil_crabdb_create_table(db, "table1");
...
FOSSIL_TEST_CASE(cpp_test_crabdb_non_existing_table) {
    fossil_crabdb_t* db = fossil_crabdb_create();
...
FOSSIL_TEST_GROUP(cpp_crab_database_tests) {    
    ...
    FOSSIL_TEST_ADD(cpp_crabdb_fixture, cpp_test_crabdb_insert_duplicate_key);
    FOSSIL_TEST_ADD(cpp_crabdb_fixture, cpp_test_crabdb_select_existing_key);
    FOSSIL_TEST_ADD(cpp_crabdb_fixture, cpp_test_crabdb_select_non_existing_key);
    FOSSIL_TEST_ADD(cpp_crabdb_fixture, cpp_test_crabdb_update);
    FOSSIL_TEST_ADD(cpp_crabdb_fixture, cpp_test_crabdb_delete);
    FOSSIL_TEST_ADD(cpp_crabdb_fixture, cpp_test_crabdb_delete_non_existing_key);
    FOSSIL_TEST_ADD(cpp_crabdb_fixture, cpp_test_crabdb_cleanup_expired);
    FOSSIL_TEST_ADD(cpp_crabdb_fixture, cpp_test_crabdb_update_batch);
    FOSSIL_TEST_ADD(cpp_crabdb_fixture, cpp_test_crabdb_delete_batch);
    FOSSIL_TEST_ADD(cpp_crabdb_fixture, cpp_test_crabdb_insert_null_key);
    FOSSIL_TEST_ADD(cpp_crabdb_fixture, cpp_test_crabdb_insert_null_value);
    FOSSIL_TEST_ADD(cpp_crabdb_fixture, cpp_test_crabdb_select_null_key);
    FOSSIL_TEST_ADD(cpp_crabdb_fixture, cpp_test_crabdb_update_null_key);
    FOSSIL_TEST_ADD(cpp_crabdb_fixture, cpp_test_crabdb_update_null_value);
    FOSSIL_TEST_ADD(cpp_crabdb_fixture, cpp_test_crabdb_delete_null_key);
    FOSSIL_TEST_ADD(cpp_crabdb_fixture, cpp_test_crabdb_concurrent_access);
    FOSSIL_TEST_ADD(cpp_crabdb_fixture, cpp_test_crabdb_insert_large_data);
    FOSSIL_TEST_ADD(cpp_crabdb_fixture, cpp_test_crabdb_select_insufficient_buffer);
    FOSSIL_TEST_ADD(cpp_crabdb_fixture, cpp_test_crabdb_count_keys);
    FOSSIL_TEST_ADD(cpp_crabdb_fixture, cpp_test_crabdb_invalid_data_type);
    FOSSIL_TEST_ADD(cpp_crabdb_fixture, cpp_test_crabdb_update_batch_invalid_data);
    FOSSIL_TEST_ADD(cpp_crabdb_fixture, cpp_test_crabdb_delete_batch_non_existing_keys);
    FOSSIL_TEST_ADD(cpp_crabdb_fixture, cpp_test_crabdb_create_table);
    FOSSIL_TEST_ADD(cpp_crabdb_fixture, cpp_test_crabdb_create_duplicate_table);
    FOSSIL_TEST_ADD(cpp_crabdb_fixture, cpp_test_crabdb_delete_table);
    FOSSIL_TEST_ADD(cpp_crabdb_fixture, cpp_test_crabdb_delete_non_existing_table);
    FOSSIL_TEST_ADD(cpp_crabdb_fixture, cpp_test_crabdb_select_from_table);
    FOSSIL_TEST_ADD(cpp_crabdb_fixture, cpp_test_crabdb_select_non_existing_table);
    FOSSIL_TEST_ADD(cpp_crabdb_fixture, cpp_test_crabdb_update_table_record);
    FOSSIL_TEST_ADD(cpp_crabdb_fixture, cpp_test_crabdb_batch_insert_table);
    FOSSIL_TEST_ADD(cpp_crabdb_fixture, cpp_test_crabdb_batch_update_table);
    FOSSIL_TEST_ADD(cpp_crabdb_fixture, cpp_test_crabdb_table_exists);
    FOSSIL_TEST_ADD(cpp_crabdb_fixture, cpp_test_crabdb_non_existing_table);
